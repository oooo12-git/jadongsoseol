...
def update_evaluation_sheet(data):
    ...
    update_sheet('evaluation!K2', [data['krw_cost']])
    update_sheet('evaluation!L2', [data['prompt_tokens']])
    update_sheet('evaluation!M2', [data['completion_tokens']])
    update_sheet('evaluation!N2', [data['total_tokens']])
    update_sheet('evaluation!O2', [data['translation_prompt_tokens']])
    update_sheet('evaluation!P2', [data['translation_completion_tokens']])
    update_sheet('evaluation!Q2', [data['translation_total_tokens']])
    total_tokens = data['total_tokens'] + data['translation_total_tokens']
    update_sheet('evaluation!R2', [total_tokens])
